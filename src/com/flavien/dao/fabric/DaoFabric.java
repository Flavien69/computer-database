...
public final class DaoFabric {
	...
	public CompanyDao createCompanyDao() {
		CompanyDao companyDao = new CompanyDao(this.DB_HOST,this.DB_PORT,this.DB_NAME,this.DB_USER,this.DB_PWD);
		return companyDao;
	}
	
	public ComputerDao createComputerDao(){
		ComputerDao computerDao = new ComputerDao(this.DB_HOST,this.DB_PORT,this.DB_NAME,this.DB_USER,this.DB_PWD);
		return computerDao;
	}
