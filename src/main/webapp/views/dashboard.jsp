...
<body>
    ...
    <section id="main">
        <div class="container">
            <h1 id="homeTitle">
                 ${page.nbTotalComputer} Computers found
            </h1>
    ...
    <footer class="navbar-fixed-bottom">
        <div class="container text-center">
            <ul class="pagination">
              ...
              <c:forEach var="i" begin="0" end="${page.nbTotalPage}">
                 <c:choose>
				    <c:when test="${page.index == i}">
              			<li class="active"><a href="<c:url value="dashboard?index=${i}"/>">${i}</a></li>
				    </c:when>
				    <c:otherwise>
              			<li><a href="<c:url value="dashboard?index=${i}"/>">${i}</a></li>
				    </c:otherwise>
				 </c:choose> 
			  </c:forEach>		                  	
              <li>
